...
INJECTION_PATTERNS = [
    ...
    r"forget (all |the )?(prior|previous) (instructions|prompts|rules|guidelines)",
    r"system (message|instruction|instructions)",
    r"reveal (your|the)? ?(system|prompt|instructions|message|secret|secrets)",
    r"secret (environment|env|variable|variables|key|token)",
