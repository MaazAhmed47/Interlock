...
TOOL_POLICIES = {
    "execute_sql":      {"patterns": DANGEROUS_SQL,     "severity": "CRITICAL", "msg": "Destructive SQL operation detected"},
    "run_sql":          {"patterns": DANGEROUS_SQL,     "severity": "CRITICAL", "msg": "Destructive SQL operation detected"},
    "query_database":   {"patterns": DANGEROUS_SQL,     "severity": "CRITICAL", "msg": "Dangerous database query detected"},
    "run_code":         {"patterns": DANGEROUS_CODE,    "severity": "CRITICAL", "msg": "Dangerous code execution detected"},
    "execute_python":   {"patterns": DANGEROUS_CODE,    "severity": "CRITICAL", "msg": "Dangerous Python execution detected"},
    "execute_js":       {"patterns": DANGEROUS_CODE,    "severity": "CRITICAL", "msg": "Dangerous JavaScript execution detected"},
    "bash":             {"patterns": DANGEROUS_CODE,    "severity": "CRITICAL", "msg": "Dangerous shell command detected"},
    "shell":            {"patterns": DANGEROUS_CODE,    "severity": "CRITICAL", "msg": "Dangerous shell command detected"},
    "terminal":         {"patterns": DANGEROUS_CODE,    "severity": "CRITICAL", "msg": "Dangerous terminal command detected"},
    "read_file":        {"patterns": DANGEROUS_FILES,   "severity": "HIGH",     "msg": "Access to sensitive file path detected"},
    "write_file":       {"patterns": DANGEROUS_FILES,   "severity": "CRITICAL", "msg": "Write to sensitive file path detected"},
    "delete_file":      {"patterns": DANGEROUS_FILES,   "severity": "CRITICAL", "msg": "Deletion of sensitive file detected"},
    "http_request":     {"patterns": DANGEROUS_NETWORK, "severity": "HIGH",     "msg": "Request to internal/restricted network"},
    "web_request":      {"patterns": DANGEROUS_NETWORK, "severity": "HIGH",     "msg": "Request to internal/restricted network"},
    "fetch_url":        {"patterns": DANGEROUS_NETWORK, "severity": "HIGH",     "msg": "Request to restricted URL detected"},
    "send_request":     {"patterns": DANGEROUS_NETWORK, "severity": "HIGH",     "msg": "Request to restricted endpoint detected"},
}
