...
export function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-screen w-[220px] bg-[#101412] border-r border-[#27302B] flex flex-col z-40">
      <div className="flex items-center gap-2.5 px-5 h-14 border-b border-[#27302B] shrink-0">
      ...
      <nav className="flex-1 py-4 px-2 overflow-y-auto">
        <p className="text-[10px] font-mono font-semibold text-[#6B7670] tracking-widest px-3 mb-2 uppercase select-none">
          Console
        </p>
        {NAV.map(({ to, icon: Icon, label }) => (
          <NavLink
            ...
            to={to}
            className={({ isActive }) =>
              'flex items-center gap-3 px-3 py-2 rounded text-sm transition-all duration-100 mb-0.5 border-l-2 ' +
              (isActive
                ? 'text-[#10B981] bg-[rgba(16,185,129,0.08)] border-[#10B981] pl-[10px]'
      ...
      <div className="px-4 py-3 border-t border-[#27302B] shrink-0">
