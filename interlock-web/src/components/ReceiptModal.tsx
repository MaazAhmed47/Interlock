          ...
          <>
            <div className="receipt-doc">
              ...
              <footer className="receipt-foot">
                <FileText size={11} />
                <span>Generated by Interlock — MCP runtime trust layer for AI agents. Each receipt is hash-chained to the prior event; altering any record breaks the chain. Receipts are not externally signed or independently anchored.</span>
              </footer>
            </div>
